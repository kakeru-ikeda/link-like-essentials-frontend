...
function buildExcerpt(body: string | undefined, length = 140): string {
  if (!body) return '';
    ...
    >
      <article>
        ...
        <div className="flex min-h-[180px] flex-col px-5 pb-5 pt-4">
          ...
          {category && (
            <span className="mt-auto inline-flex items-center self-start rounded-full bg-slate-100 px-2.5 py-1 pt-2 text-xs font-medium text-slate-700">
              {category}
            </span>
          )}
        </div>
